export enum PATIENT_ERROR_MESSAGES {
  ...
  MEDICATION_STRING = 'El medicamento debe ser un caracter',
  MEDICATION_REQUIRED = 'El nombre de la la medicación es requerido',
  MEDICATIONS_ARRAY = 'Los medicamentos debe ser una lista',
